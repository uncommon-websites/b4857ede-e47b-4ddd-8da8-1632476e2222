...
<script lang="ts">
  ...
  name: "Jordan Lee",
  role: "Founder",
  image: "/generated/image-a-headshot-of-a-friendly-small-business-.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"I started Commerce Systems because I was spending more time managing chaos than growing my business. We set out to simplify day-to-day operations for people like us who do it all."`}
    />
